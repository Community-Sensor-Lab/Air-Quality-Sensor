...
**NOTE: This procedure only works with the old Arduino IDE that has the round icon <img src="../images/image1.png" width="64" height="34" alt="Arduino IDE V1.x"> **(V1.x)**

**It does not work on the new IDE with the square icon <img src="../images/image2.png" width="34" height="64" alt="Arduino IDE V2.x"> **(V2.x)**
