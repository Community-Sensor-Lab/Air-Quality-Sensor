...
**NOTE: This procedure only works with the old Arduino IDE that has the round icon <img src="../images/image1.jpg" width="24" height="24" alt="Arduino IDE V1.x"> **(V1.x)**   
**It does not work on the new IDE with the square icon <img src="../images/image2.png" width="24" height="24" alt="Arduino IDE V2.x"> **(V2.x)**
