...
**NOTE: This procedure only works with the old Arduino IDE that has the round icon ![](../images/image1.jpg)(V1.x)**   
**It does not work on the new IDE with the square icon ![](../images/image2.png)(V2.x)**
