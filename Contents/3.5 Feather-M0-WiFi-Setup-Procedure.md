...
**NOTE: This procedure only works with the old Arduino IDE that has the round icon <img src="../images/image1.jpg" width="34" height="34" alt="Arduino IDE V1.x"> **(V1.x)**   
