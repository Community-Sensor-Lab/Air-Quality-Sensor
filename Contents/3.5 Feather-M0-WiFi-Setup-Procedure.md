...
✅ ESP32 Provisioning Flowchart (Reference)
While this guide focuses on the Feather M0 WiFi board, many of the same principles apply to ESP32-based systems used in other CSL sensor builds. To help visualize the provisioning process—including WiFi setup, sensor initialization, and cloud integration—refer to the flowchart below:

<div align="center"> <img src="../images/esp32_provisioning_flowchart.JPG" width="80%"/> </div>

This diagram outlines:

🔌 Hardware setup and boot sequence

📶 WiFi credential input and connection logic

🌡️ Sensor calibration and data logging

☁️ Optional cloud services integration

Use this as a reference when adapting firmware or onboarding new contributors working with ESP32 boards.
