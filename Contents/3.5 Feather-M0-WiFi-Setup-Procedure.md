...
**NOTE: This procedure only works with the old Arduino IDE that has the round icon** ![Arduino IDE V1.x][image1] **(V1.x)**

**It does not work on the new IDE with the square icon** ![Arduino IDE V2.x][image2] **(V2.x)**
