...
String readSen5x() {
  ...
  String sen5xString = String(massConcentrationPm1p0) + String(", ") + String(massConcentrationPm2p5) + String(", ") + String(massConcentrationPm4p0) + String(", ") + String(massConcentrationPm10p0) + String(", ") + String(numberConcentrationPm0p5) + String(",") + String(numberConcentrationPm1p0) + String(",") + String(numberConcentrationPm2p5) + String(",") + String(numberConcentrationPm4p0) + String(",") + String(numberConcentrationPm10p0) + String(",") + String(typicalParticleSize) + String(",") + String(ambientHumidity) + String(", ") + String(ambientTemperature) + String(", ") + String(vocIndex) + String(", ") + String(noxIndex);
  return sen5xString;
}
